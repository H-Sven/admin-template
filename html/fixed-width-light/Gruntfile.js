...
module.exports = function(grunt) {
  ...
  grunt.registerTask('dark-version',  ['sass:dark','jshint:all','connect:server','watch:darksrc']);
  grunt.registerTask('sass-compile',  ['sass:dist','watch:src']);
  grunt.registerTask('sass-dark',  ['sass:dark','watch:darksrc']);
  grunt.registerTask('sass-rtl',  ['sass:rtl','watch:rtlsrc']);
};